...
export interface WsRpcClient {
  ...
  readonly server: {
    ...
    readonly getComposerSlashCommands: RpcUnaryMethod<
      typeof WS_METHODS.serverGetComposerSlashCommands
    >;
    readonly getRoadmapStatus: RpcUnaryNoArgMethod<typeof WS_METHODS.serverGetRoadmapStatus>;
    readonly getPiDoctorReport: RpcUnaryNoArgMethod<typeof WS_METHODS.serverGetPiDoctorReport>;
    readonly getPiWorkspace: RpcUnaryNoArgMethod<typeof WS_METHODS.serverGetPiWorkspace>;
    readonly readPiResource: RpcUnaryMethod<typeof WS_METHODS.serverReadPiResource>;
    readonly writePiResource: RpcUnaryMethod<typeof WS_METHODS.serverWritePiResource>;
  ...
  readonly orchestration: {
    ...
    readonly sendStreamingMessage: RpcUnaryMethod<
      typeof ORCHESTRATION_WS_METHODS.sendStreamingMessage
    >;
...
export function createWsRpcClient(transport = new WsTransport()): WsRpcClient {
  return {
    ...
    server: {
      ...
      getComposerSlashCommands: (input) =>
        transport.request((client) => client[WS_METHODS.serverGetComposerSlashCommands](input)),
      getRoadmapStatus: () =>
        transport.request((client) => client[WS_METHODS.serverGetRoadmapStatus]({})),
      getPiDoctorReport: () =>
        transport.request((client) => client[WS_METHODS.serverGetPiDoctorReport]({})),
      getPiWorkspace: () =>
        transport.request((client) => client[WS_METHODS.serverGetPiWorkspace]({})),
      readPiResource: (input) =>
        transport.request((client) => client[WS_METHODS.serverReadPiResource](input)),
      writePiResource: (input) =>
        transport.request((client) => client[WS_METHODS.serverWritePiResource](input)),
    ...
    orchestration: {
      ...
      sendStreamingMessage: (input) =>
        transport.request((client) => client[ORCHESTRATION_WS_METHODS.sendStreamingMessage](input)),
      getTurnDiff: (input) =>
