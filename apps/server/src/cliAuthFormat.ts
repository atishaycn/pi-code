...
export interface IssuedPairingLink {
  ...
  readonly role: AuthPairingLink["role"];
  readonly subject: string;
  readonly createdAt: DateTime.DateTime | DateTime.Utc;
  readonly expiresAt: DateTime.DateTime | DateTime.Utc;
}

export interface IssuedBearerSession {
  readonly sessionId: AuthClientSession["sessionId"];
  readonly token: string;
  readonly method: AuthClientSession["method"];
  readonly role: AuthClientSession["role"];
  readonly subject: AuthClientSession["subject"];
