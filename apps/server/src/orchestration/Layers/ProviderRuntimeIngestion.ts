      ...
      return [
        {
          ...
          payload: {
            ...
            ...(event.payload.responseKind ? { responseKind: event.payload.responseKind } : {}),
            ...(event.payload.title ? { title: event.payload.title } : {}),
            ...(event.payload.placeholder ? { placeholder: event.payload.placeholder } : {}),
            ...(event.payload.prefill !== undefined ? { prefill: event.payload.prefill } : {}),
    ...
    case "task.progress": {
      ...
      const description =
        typeof event.payload.description === "string"
          ? truncateDetail(event.payload.description)
          : undefined;
      return [
        {
          id: event.eventId,
          ...
          tone: "thinking",
          kind: "task.progress",
          summary: summary ?? "Reasoning update",
          payload: {
            taskId: event.payload.taskId,
            ...((description ?? summary) ? { detail: description ?? summary } : {}),
            ...(summary ? { summary } : {}),
...
const make = Effect.fn("make")(function* () {
  ...
  const processRuntimeEvent = Effect.fn("processRuntimeEvent")(function* (
    ...
    if (event.type === "turn.completed") {
      ...
      const status =
        normalizeRuntimeTurnState(event.payload.state) === "failed" ? "error" : "ready";
      const lastError =
