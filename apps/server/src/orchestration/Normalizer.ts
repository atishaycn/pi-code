...
import {
  ...
  type OrchestrationStreamingMessageInput,
...
export const persistUploadedChatAttachments = (
  threadId: string,
  attachments: ReadonlyArray<
    NonNullable<OrchestrationStreamingMessageInput["attachments"]>[number]
  >,
) =>
  Effect.gen(function* () {
...
export const normalizeDispatchCommand = (command: ClientOrchestrationCommand) =>
  Effect.gen(function* () {
    ...
    const normalizedAttachments = yield* persistUploadedChatAttachments(
      command.threadId,
