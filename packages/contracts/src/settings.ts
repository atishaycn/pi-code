...
export const ClientSettingsSchema = Schema.Struct({
  ...
  skipWorkWhileScrolling: Schema.Boolean.pipe(Schema.withDecodingDefault(() => false)),
...
export const CodexSettings = Schema.Struct({
  ...
  enableAutoreason: Schema.Boolean.pipe(Schema.withDecodingDefault(() => false)),
  fullAutonomy: Schema.Boolean.pipe(Schema.withDecodingDefault(() => false)),
