...
export const WS_METHODS = {
  ...
  serverGetComposerSlashCommands: "server.getComposerSlashCommands",
  serverGetRoadmapStatus: "server.getRoadmapStatus",
  serverGetPiDoctorReport: "server.getPiDoctorReport",
  serverGetPiWorkspace: "server.getPiWorkspace",
  serverReadPiResource: "server.readPiResource",
  serverWritePiResource: "server.writePiResource",
...
export const WsServerGetComposerSlashCommandsRpc = Rpc.make(
  WS_METHODS.serverGetComposerSlashCommands,
  {
    payload: ServerGetComposerSlashCommandsInput,
    success: ServerGetComposerSlashCommandsResult,
    error: ServerGetComposerSlashCommandsError,
  },
);

export const WsServerGetRoadmapStatusRpc = Rpc.make(WS_METHODS.serverGetRoadmapStatus, {
  payload: Schema.Struct({}),
  success: ServerGetRoadmapStatusResult,
  error: ServerRoadmapStatusError,
});

export const WsServerGetPiDoctorReportRpc = Rpc.make(WS_METHODS.serverGetPiDoctorReport, {
  payload: Schema.Struct({}),
  success: ServerGetPiDoctorReportResult,
  error: ServerPiDoctorError,
});

export const WsServerGetPiWorkspaceRpc = Rpc.make(WS_METHODS.serverGetPiWorkspace, {
  payload: Schema.Struct({}),
  success: ServerGetPiWorkspaceResult,
  error: ServerPiRpcError,
});

export const WsServerReadPiResourceRpc = Rpc.make(WS_METHODS.serverReadPiResource, {
  payload: ServerReadPiResourceInput,
  success: ServerReadPiResourceResult,
  error: ServerPiRpcError,
});

export const WsServerWritePiResourceRpc = Rpc.make(WS_METHODS.serverWritePiResource, {
  payload: ServerWritePiResourceInput,
  success: ServerWritePiResourceResult,
  error: ServerPiRpcError,
});
...
export const WsOrchestrationSendStreamingMessageRpc = Rpc.make(
  ORCHESTRATION_WS_METHODS.sendStreamingMessage,
  {
    payload: OrchestrationRpcSchemas.sendStreamingMessage.input,
    success: OrchestrationRpcSchemas.sendStreamingMessage.output,
    error: OrchestrationDispatchCommandError,
  },
);
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsServerGetComposerSlashCommandsRpc,
  WsServerGetRoadmapStatusRpc,
  WsServerGetPiDoctorReportRpc,
  WsServerGetPiWorkspaceRpc,
  WsServerReadPiResourceRpc,
  WsServerWritePiResourceRpc,
  ...
  WsOrchestrationSendStreamingMessageRpc,
